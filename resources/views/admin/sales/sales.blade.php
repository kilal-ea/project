...
@section('admin')
    ...
    <nav class="flex justify-between items-center p-4">
        <div>
            ...
            <button onclick="window.location='{{ route('allsales') }}'" class='  w-full py-5 font-semibold text-white bg-emerald-500 border-r-2' style="font-family: Arial, sans-serif;">Show all sales</button>
